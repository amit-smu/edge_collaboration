...
if __name__ == "__main__":
    ...
    INPUT_DIR = r"../performance_analysis/spatial_area_estimation_WT/"
    ref_cam = 1
    collab_cam = 4

    gt_overlap_coords_1_4 = ()
    ...
    # if collab_cam == 4:
    #     gt_overlap_coords = gt_overlap_coords_1_4
    # elif collab_cam == 6:
    ...
    cv2.rectangle(frame_copy, (0, 0), (1920, 1080), (0, 0, 0), 2)

    cv2.imwrite("estimated_area_c{}_{}_WT.jpg".format(ref_cam, collab_cam), frame_copy)
    cv2.waitKey(-1)
