"""
module to check if the image cropper has cropped properly or not (used for images cropped using sp overlap area coordinates (gt))
"""
...
if __name__ == "__main__":
    ...
    if DATASET == "WT":
        ...
        imageset_dir = r"../../dataset/Wildtrack_dataset/PNGImages_cropped_r{}_c{}_{}".format(ref_cam, collab_cam,
                                                                                              collab_cam)
        annotation_dir = r"../../dataset/Wildtrack_dataset/Annotations_cropped_r{}_c{}_{}".format(ref_cam, collab_cam,
                                                                                                  collab_cam)
        img_type = "png"
    ...
    if DATASET == "PETS":
        ...
        imageset_dir = r"../../dataset/PETS_org/JPEGImages_cropped_r{}_c{}_{}".format(ref_cam, collab_cam,
                                                                                      ref_cam)
        annotation_dir = r"../../dataset/PETS_org/Annotations_cropped_r{}_c{}_{}".format(ref_cam,
                                                                                         collab_cam,
                                                                                         ref_cam)
        img_type = "jpg"
