...
if __name__ == "__main__":
    ...
    if DATASET == "WT":
        ...
        output_img_dir_r = r"../../dataset/Wildtrack_dataset/PNGImages_cropped_r{}_c{}_{}".format(ref_cam, collab_cam,
                                                                                                  ref_cam)
        output_annot_dir_r = r"../../dataset/Wildtrack_dataset/Annotations_cropped_r{}_c{}_{}".format(ref_cam,
                                                                                                      collab_cam,
                                                                                                      ref_cam)
        output_img_dir_c = r"../../dataset/Wildtrack_dataset/PNGImages_cropped_r{}_c{}_{}".format(ref_cam, collab_cam,
                                                                                                  collab_cam)
        output_annot_dir_c = r"../../dataset/Wildtrack_dataset/Annotations_cropped_r{}_c{}_{}".format(ref_cam,
                                                                                                      collab_cam,
                                                                                                      collab_cam)
        SP_OVERLAP_GT_DIR = "{}/{}".format(SP_OVERLAP_GT_DIR, "WILDTRACK")
        frame_prefix = "000000"
        img_prefix = "C"
        img_type = "png"
    ...
    for ti_name in test_img_names:
        ...
        ti_name_collab = "C{}_{}".format(collab_cam, ti_name[3:])
        ...
        ref_file_name = "{}/{}.png".format(output_img_dir_r, ti_name)
        collab_file_name = "{}/{}.png".format(output_img_dir_c, ti_name_collab)
