...
class DataGenerator:
    ...
    def __init__(self,
        ...
        print("\ntesting on resolution : {}\n".format(self.test_resolution))
    ...
    def generate(self,
        ...
        while True:
            ...
            if self.test_dataset == "VOC":
                batch_X_aux = self.get_aux_channels(300, 300, batch_filenames)
            elif self.test_dataset == "PETS":
                batch_X_aux = self.get_aux_channels(img_height=300, img_width=300, batch_file_names=batch_filenames)
            else:
                print("Wrong dataset received..")
