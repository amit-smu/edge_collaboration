...
class DataGenerator:
    ...
    # def randomize_box_coords(self, annot_path, aux_channel, flag):
    ...
    #             width = xmax - xmin
    #             height = ymax - ymin
    #             shift_amt = random.randint(0, SHIFT_RANGE)
    #             # shift left or right
    #             if flag == "LEFT":
    ...
    #
    #         if i < 10:
    #             aux_channel = self.randomize_box_coords(annot_path, aux_channel, "LEFT")
    #         elif i < 20:
    #             aux_channel = self.randomize_box_coords(annot_path, aux_channel, "RIGHT")
    #         else:
    ...
    def get_aux_channels(self, img_height, img_width, batch_file_names):
        ...
        for i in range(len(batch_file_names)):
            ...
            if i < int(0.70 * batch_size):
                aux_channel = self.randomize_box_coords(annot_path, aux_channel, randomize=True)
            else:
