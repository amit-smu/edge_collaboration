...
class DataGenerator:
    ...
    def create_mixed_res_imges_WT(self, batch_x):
        ...
        shared_reg_coords = [466, 0, 700, 700]
    ...
    def generate(self,
        ...
        while True:
            ...
            self.dump_raw_data(batch_x_data=batch_X.copy(), batch_y_data=batch_y, batch_x_aux=batch_X_aux, batch_img_ids=batch_image_ids)
