...
from data_generator.object_detection_2d_data_generator_aux import DataGenerator
...
csv_logger = CSVLogger(filename='aux_input_trained_models/ssd300_pascal_07+12+PETS_training_log.csv',
                       separator=',',
                       append=True)
...
initial_epoch = 0
final_epoch = 120
steps_per_epoch = ceil(train_dataset_size / batch_size) + 100
