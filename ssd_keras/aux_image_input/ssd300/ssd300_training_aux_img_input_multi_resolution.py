...
from data_generator.object_detection_2d_data_generator_aux_multi_resolution import DataGenerator
...
model = ssd_300_aux(image_size=(img_height, img_width, img_channels),
                    n_classes=n_classes,
                    mode='training',
...
train_dataset = DataGenerator(load_images_into_memory=True, hdf5_dataset_path=None, train_resolution=(300, 300))
val_dataset = DataGenerator(load_images_into_memory=True, hdf5_dataset_path=None, train_resolution=(300, 300))
...
model_checkpoint = ModelCheckpoint(
    filepath='aux_input_trained_models/ssd300_pascal_07+12_randomized_all_classes_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
    # filepath='aux_input_single_resol_trained_models/ssd300_pascal_07+12_256x256_+epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
...
csv_logger = CSVLogger(
    filename='aux_input_trained_models/ssd300_pascal_07+12_randomized_person_only_training_log.csv',
    separator=',',
    append=True)
