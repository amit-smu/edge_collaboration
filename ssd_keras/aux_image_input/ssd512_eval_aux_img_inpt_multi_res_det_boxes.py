"""
Evaluation script for SSD512 architecture where mask/prior is created using detected boxes instead of rand ground truth
"""
...
from data_generator.object_detection_2d_data_gen_aux_multi_res_eval_512_det_boxes import DataGenerator
