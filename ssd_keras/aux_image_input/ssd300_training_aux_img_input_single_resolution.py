...
from data_generator.object_detection_2d_data_generator_aux_single_resolution import DataGenerator
...
train_dataset = DataGenerator(load_images_into_memory=True, hdf5_dataset_path=None, target_resolution=(196, 196))
val_dataset = DataGenerator(load_images_into_memory=True, hdf5_dataset_path=None, target_resolution=(196, 196))
...
model_checkpoint = ModelCheckpoint(
    # filepath='aux_input_trained_models/ssd300_pascal_07+12+epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
    filepath='aux_input_single_resol_trained_models/ssd300_pascal_07+12_196x196_+epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
...
csv_logger = CSVLogger(filename='aux_input_single_resol_trained_models/ssd300_pascal_07+12+PETS_training_log.csv',
                       separator=',',
                       append=True)
...
initial_epoch = 0
final_epoch = 120
steps_per_epoch = 2 * ceil(val_dataset_size / batch_size)
