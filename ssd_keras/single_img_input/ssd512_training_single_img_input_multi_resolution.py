...
scales_pascal = [0.07, 0.15, 0.3, 0.45, 0.6, 0.75, 0.9,
...
train_dataset.parse_xml(images_dirs=[WT_dataset_images_dir,
                        ...
                        image_set_filenames=[WT_dataset_trainval_image_set_filename,
                                             PETS_trainval_image_set_filename],
                        annotations_dirs=[WT_dataset_annotations_dir,
                                          PETS_annotations_dir],
                        classes=classes,
                        # include_classes='all',
                        include_classes=[15],
                        exclude_truncated=False,
...
val_dataset.parse_xml(images_dirs=[WT_dataset_images_dir,
                                   PETS_images_dir],
                      image_set_filenames=[WT_dataset_test_image_set_filename,
                                           PETS_test_image_set_filename],
                      annotations_dirs=[WT_dataset_annotations_dir,
                                        PETS_annotations_dir],
                      classes=classes,
                      # include_classes='all',
...
model_checkpoint = ModelCheckpoint(
    filepath='single_img_models/ssd512_PETS+WT_person_180_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
