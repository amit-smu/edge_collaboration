...
os.environ["CUDA_VISIBLE_DEVICES"] = "7,2"
...
print("\ntraining on weight file : {}".format(weights_path))
...
PETS_images_dir = '/root/dataset/PETS_org/JPEGImages/'
...
PETS_annotations_dir = '/root/dataset/PETS_org/Annotations'
...
PETS_trainval_image_set_filename = '/root/dataset/PETS_org/ImageSets/Main/trainval_88.txt'
VOC_2007_trainval_image_set_filename = '/root/dataset/PASCAL_VOC/VOC2007/VOCdevkit/VOC2007/ImageSets/Main/trainval.txt'
VOC_2012_trainval_image_set_filename = '/root/dataset/PASCAL_VOC/VOC2012/VOCdevkit/VOC2012/ImageSets/Main/trainval.txt'
...
PETS_test_image_set_filename = '/root/dataset/PETS_org/ImageSets/Main/test_12.txt'
VOC_2007_test_image_set_filename = '/root//dataset/PASCAL_VOC/VOC2007/VOCdevkit/VOC2007/ImageSets/Main/test.txt'
...
train_dataset.parse_xml(images_dirs=[VOC_2007_images_dir,
                        ...
                        ret=False)
# train_dataset.parse_xml(images_dirs=[PETS_images_dir,
#                                      VOC_2007_images_dir,
#                                      VOC_2012_images_dir],
#                         image_set_filenames=[PETS_trainval_image_set_filename,
...
model_checkpoint = ModelCheckpoint(
    filepath='single_img_models/ssd300_pascal_07+12_all_classes_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
...
csv_logger = CSVLogger(filename='single_img_models/ssd300_pascal_07+12_person_only_training_log.csv',
                       separator=',',
                       append=True)
...
initial_epoch = 0
final_epoch = 120
steps_per_epoch = ceil(train_dataset_size / batch_size) + 30
