...
if __name__ == "__main__":
    img_dir = "dataset_org/Wildtrack_dataset/PNGImages/"
    annot_dir = "dataset_org/Wildtrack_dataset/labels/"
    img_output_dir = "./prior_img_model/data_1920/Images/"
    ...
    for name in fnames:
        if name.__contains__("txt"):
            continue
        print(name)
        image = cv2.imread("{}/{}".format(img_dir, name))
        ...
        annot_file_path = "{}/{}.txt".format(annot_dir, name[:-4])
